...
public class engineAudio : MonoBehaviour{
    ...
    private void FixedUpdate(){
        ...
        accFade = Mathf.Lerp(accFade,Mathf.Abs( acceleration ), 15 * Time.deltaTime );
            ...
            if(carController.checkIfAcclerating()){
                acceleration = 1;
            }
            else{
                acceleration = 0;
            ...
            float pitch = ULerp(lowPitchMin, lowPitchMax, engineRPM / carController.maxRPM);
            ...
            float highFade = Mathf.InverseLerp(0.2f, 0.8f,  engineRPM / carController.maxRPM);
